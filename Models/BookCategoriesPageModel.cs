...
namespace Oros_Anamaria_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Oros_Anamaria_Lab9Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Oros_Anamaria_Lab9Context context,
